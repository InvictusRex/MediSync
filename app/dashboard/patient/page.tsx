          ...
          <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>Fill in the details to schedule an appointment with a doctor.</DialogDescription>
              </DialogHeader>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {upcomingAppointments.length > 0 ? format(new Date(upcomingAppointments[0].date), "MMM d") : "None"}
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-4 p-4 border rounded-md">
                      <p>{patientInfo.medicalHistory || "No medical conditions recorded"}</p>
                    </div>
                  </div>
                  <div>
